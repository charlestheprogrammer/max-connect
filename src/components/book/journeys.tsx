...
const fetchSncfData = async (from: string | null, to: string | null) => {
  ...
  const res = await fetch(
    `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/tgvmax/records?select=train_no%2Corigine%2Cdestination%2Cdestination_iata%2Corigine_iata%2C%20date%2Cheure_depart%2Cheure_arrivee&where=od_happy_card%3D%27OUI%27%20AND%20origine%3D%27${from}%27%20AND%20destination%3D%27${to}%27&limit=10&offset=0&timezone=UTC&include_links=false&include_app_metas=false`
  )
